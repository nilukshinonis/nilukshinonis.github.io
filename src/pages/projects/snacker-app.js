    ...
    <section id="wrapper-govi-mithuru">
      ...
      <div className="wrapper">
        <div className="inner">
          ...
          <img className="image main" src={snacker_design_process_image} alt="" />
          ...
          <h3 className="major">Research study</h3>
          ...
          <h3 className="major">Initial design concepts</h3>
          ...
          <p>
            Then I created the user story, user journey of and crafted the
            problem statement.
          </p>
          ...
          <h3 className="major">User flow</h3>
          <p>
